...
We use analytics tools such as PostHog to understand feature usage and improve user experience. These tools collect pseudonymized behavioral data (page visits, events, clicks, device type, and session identifiers) through cookies and similar technologies. Analytics cookies are non-essential and used only after you provide consent through our cookie banner. You may withdraw consent at any time.
...
## 3. Age Requirement
The Site and Services are intended only for individuals 18 years of age or older. We do not knowingly collect information from anyone under 18. If you are under 18, you must not register or use the Services. If we learn that we have collected data from a minor without verified parental consent, we will delete it promptly.

For inquiries or deletion requests related to minor data, contact legal@parsonos.com.
...
You retain full ownership of all data and materials you provide (“User Data”). We obtain no ownership rights in your content. You grant Parsonos Corporation a limited, revocable, non-exclusive, royalty-free license to process your data solely to provide and maintain the Services, perform security and integrity checks, comply with legal obligations, and improve non-personal system performance. This license automatically terminates when the data is deleted from our systems under the retention terms below.
We do not use, train, or otherwise repurpose your User Data for generative models, marketing, or profiling.
...
We retain personal data only for as long as necessary to deliver the Services, fulfill contractual or legal obligations, or enforce our rights.

1. **Active Projects** – Data linked to active projects remains stored until you delete the project or your account.
2. **Inactive Projects** – Projects not accessed for 30 days may be archived or deleted after prior notice.
3. **User-initiated Deletion** – You may delete projects or your entire account at any time through your dashboard. Upon deletion, we permanently remove personal identifiers from active systems within 30 days and purge remaining backups in scheduled rotations.
4. **Residual Logs** – Minimal operational logs (such as access and error records) may persist for security and audit purposes but no longer identify you personally.
5. **Legal Holds** – We may retain specific records when required by law or to resolve disputes.

After deletion, we may keep anonymized, non-identifiable data to analyze service reliability and performance.
...
# VIII. THIRD-PARTY SOFTWARE AND DATA PROCESSING
...
**Last Updated: This Privacy Policy was last updated on 6th November, 2025**
