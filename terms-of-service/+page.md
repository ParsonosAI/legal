...
Version 1.0
*Last revised on: 6th November, 2025*
...
- **Personal Use**: Unless you have a separate enterprise agreement with Parsonos Corporation or its authorized affiliate, the Services and Site are provided for personal or small-team use only. Enterprise, studio, or reseller use requires a separate contract. The Company may suspend accounts that substantially exceed normal individual usage.
...
You are strictly prohibited from using the Site or its services for any purpose other than those explicitly permitted above and in 2.2, including but not limited to unauthorized reproduction, distribution, or modification of the services or content provided by the Site.
...
The Site uses cookies and analytics tools (e.g. PostHog) to understand usage patterns and improve functionality. Non-essential cookies are activated only after you provide consent via the cookie banner. Details appear in our Privacy Policy.
...
- You have all necessary rights, licenses, and permissions to provide the User Content to Company for the purposes outlined in these Terms.
...
TO THE MAXIMUM EXTENT PERMITTED BY LAW, THE TOTAL CUMULATIVE LIABILITY OF PARSONOS CORPORATION AND ITS AFFILIATES FOR ALL CLAIMS ARISING FROM OR RELATED TO THE SITE OR SERVICES SHALL NOT EXCEED **THE GREATER OF USD $100 OR THE TOTAL FEES PAID BY YOU IN THE SIX (6) MONTHS PRECEDING THE EVENT GIVING RISE TO THE CLAIM**. WE SHALL NOT BE LIABLE FOR INDIRECT, CONSEQUENTIAL, SPECIAL, OR PUNITIVE DAMAGES, INCLUDING LOST PROFITS OR DATA.
...
Upon termination or account deletion, all personal data and User Content will be removed from active systems within 30 days and from backups in the normal rotation. Residual anonymized data may remain for system security and analytics but no longer identifies you.
...
If you believe that one of our users is, through the use of our Site, unlawfully infringing the copyright(s) in a work and wish to have the allegedly infringing material removed, you must provide the following information in the form of a written notification:
...
**10.7 Relationship to Other Documents:** Your use of the Services is also governed by our Privacy Policy and Subscription Service Agreement. If any conflict arises, the Subscription Service Agreement controls commercial terms, and this Terms of Use controls Site access.
